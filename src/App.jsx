...
function App() {
  ...
  return (
    <div
      className={`App ${bgImages[iconID]} bg-cover min-h-screen grid place-content-center px-2`}
    >
      {weather ? (
        <div
          className={`flex flex-col flex-wrap justify-center items-center ${
            tempCity ? "gap-8" : ""
          }  mt-[11rem] mb-12 sm:flex-row`}
        >
          ...
          <form
            ...
            className="absolute top-16 left-1/2 transform -translate-x-1/2 sm:top-[10%]"
            action=""
          >
            <input
              className="bg-white block rounded-md border-none text-gray-700 py-1 mb-4 px-4 leading-tight focus:outline-none sm:w-64"
              type="text"
            ...
            <button
              className="bg-blue-500 block mx-auto py-2 px-6 text-white font-bold rounded-full hover:bg-blue-800 duration-200 text-sm"
              type="submit"
            >
              Search
            </button>
